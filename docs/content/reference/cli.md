...
```
blockchain-info <command> [arguments] [flags]
```

Run `blockchain-info <command> --help` for the full flag list on any command. This
...
per operation you declare in `blockchain-info/domain.go`.
